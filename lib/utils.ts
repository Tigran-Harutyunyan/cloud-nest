...
export const constructDownloadUrl = (bucketFileId: string) => {
  const { APPWRITE_ENDPOINT, BUCKET, PROJECT_ID } = useRuntimeConfig().public;
  return `${APPWRITE_ENDPOINT}/storage/buckets/${BUCKET}/files/${bucketFileId}/download?project=${PROJECT_ID}`;
};
